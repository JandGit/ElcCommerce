...
public class Constants {
     ...
     * 后台用户登录接口
     */
    public static final String SERVER_ADDRESS_LOGIN = "http://192.168.1.104:8080/TKBaas/user/app/login";
    /**
     * 获取用户信息的接口
     */
    public static final String SERVER_GETUSERINFO = "http://192.168.1.104:8080/TKBaas/user/app/getInfo";
    /**
     * 获取用户购物车
